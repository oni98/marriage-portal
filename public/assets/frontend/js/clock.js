    ...
    $.fn.thooClock = function(options) {
        ...
        this.each(function() {
            ...
            defaults = {
                size: 250,
                dialColor: '#000000',
                dialBackgroundColor: '#e8ecec', //'transparent',
                secondHandColor: '#df146e',
                minuteHandColor: '#494c4e',
                hourHandColor: '#494c4e',
            ...
            function drawDial(color, bgcolor) {
                ...
                dialRadius = parseInt(radius - (el.size / 20), 10);
                dialBackRadius = radius - (el.size / 40);
                ...
                grad = ctx.createRadialGradient(0, 0, dialBackRadius * 0.95, 0, 0, dialBackRadius * 1.05);
                grad.addColorStop(0, '#df146e');
                grad.addColorStop(0.5, 'white');
                grad.addColorStop(1, '#006b00');
                ctx.strokeStyle = grad;
                ctx.lineWidth = dialBackRadius * 0.1;
                ctx.stroke();
                ...
                for (i = 1; i <= 60; i += 1) {
                    ...
                    if (i % 5 === 0) {
                        ...
                        textSize = parseInt(el.size / 10, 10);
                        ctx.font = '100 ' + textSize + 'px ' + el.numeralFont;
                        ctx.beginPath();
                        ctx.fillStyle = '#df146e'; //color;
                ...
                if (el.brandText2 !== undefined) {
                    ctx.textBaseline = 'middle';
                    ctx.font = '100 ' + parseInt(el.size / 30, 10) + 'px ' + el.brandFont;
            ...
            function drawSecondHand(milliseconds, seconds, color) {
                var shlength = (radius) - (el.size / 15);
