    ...
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <p> <strong>Bride/Groom's Profession: </strong> {{ (!empty($application->profession_id) && $professions[$application->profession_id - 1]->name != 'Others') ? $professions[$application->profession_id - 1]->name : $application->other_profession }}</p>
                <p> <strong>Father's Profession: </strong> {{ (!empty($application->father_profession) && $professions[$application->father_profession - 1]->name != 'Others') ? $professions[$application->father_profession - 1]->name : $application->father_other_profession }}</p>
                <p> <strong>Mother's Profession: </strong> {{ (!empty($application->mother_profession) && $professions[$application->mother_profession - 1]->name != 'Others') ? $professions[$application->mother_profession - 1]->name : $application->mother_other_profession }} </p>
                
                <p> <strong>Height: </strong> {{$application->height }}</p>
                <p> <strong>Father's District: </strong> {{!empty($application->father_district) && $districts[$application->father_district - 1]->name }}</p>
                <p> <strong>Mother's District: </strong> {{!empty($application->mother_district) && $districts[$application->mother_district - 1]->name }}</p>
                <p> <strong>Present District: </strong> {{!empty($application->present_district) && $districts[$application->present_district - 1]->name }}</p>
