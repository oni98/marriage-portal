<footer class="footer-above">
    <div class="container">
        <div class="row pt-5">
            <div class="col-md-3 text-justify mb-4">
                <h4 class="text-primary2 font-weight-bold">ABOUT US :::</h4>
                <p>Marriage Media or Biye Media is a portal for Bride & Groom. You can find your life partner through
                    here. We want to
            ...
            <div class="col-md-2 mb-4">
                ...
                <div class="row">
                    <div class="col-md-12">
                        <a target="_blank" href="https://www.facebook.com/biyemedia"> <i class="px-1 fa-brands fa-facebook"></i> </a>
                        <a target="_blank" href="https://wa.me/8801715949825"> <i class="px-1 fa-brands fa-whatsapp"></i> </a>
                        <a target="_blank" href="https://www.youtube.com/@biyemedia"> <i class="px-1 fa-brands fa-youtube"></i> </a>
                        <a target="_blank" href="#"> <i class="px-1 fa-brands fa-twitter"></i> </a>
                        <a target="_blank" href="#"> <i class="px-1 fa-brands fa-linkedin"></i> </a>
                    </div>
                </div>
            </div>
                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <a class="text-dark d-flex" href="https://wa.me/8801715578504" target="_blank">
                            <img src="{{ asset('assets/frontend/img/Marriage Consultant WhatsApp.webp') }}"
                                alt="Marriage Media Whatsapp" class="footer-phone-icon"> 017 1557 8504
                        </a>
                    </div>
                </div>
            </div>
    ...
    <div class="text-center bg-primary text-light py-3">
        Copyright &copy; 2023 <strong>{{ @config('app.name') }} | Developed By <a href="https://web.ankur.com.bd"
                target="_blank" class="text-white font-italic">Ankur Digital Marketing</a> </strong>
    </div>
</footer>
