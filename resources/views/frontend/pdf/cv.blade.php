    ...
    <div class="">
        ...
        <table class="mt-2 pl-2 mb-1">
            <tr>
                ...
                <td width="10%">
                    @if(!empty($user->image))
                    <img class="profile-image" src="{{ public_path('storage/' . $user->image) }}" alt="">
                    @endif
                </td>
            </tr>
        </table>
        ...
        <table class="info pl-2">
            ...
            <tr>
                <td>Profession</td>
                <td>: {{ ($professions[$user->profession_id - 1]->name != 'Others') ? $professions[$user->profession_id - 1]->name : $user->other_profession }}</td>
            </tr>
            @endif
            @if(!empty($user->religion_id))
            <tr>
                <td>Religion</td>
                <td>: {{ $religions[$user->religion_id - 1]->name }} {{ (!empty($user->caste)) ? '(' . $user->caste . ')' : '' }}</td>
            </tr>
            @endif
        ...
        <table class="info pl-2">
            ...
            <tr>
                ...
                <td>: {{ ($professions[$user->father_profession - 1]->name != 'Others') ? $professions[$user->father_profession - 1]->name : $user->father_other_profession }}</td>
            </tr>
            @endif
            ...
            <tr>
                ...
                <td>: {{ ($professions[$user->mother_profession - 1]->name != 'Others') ? $professions[$user->mother_profession - 1]->name : $user->mother_other_profession }}</td>
            </tr>
            @endif
